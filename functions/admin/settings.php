...
namespace pitchprint\functions\admin;
	...
	function ppa_cat_customize() {
		echo '<input class=regular-text id=ppa_cat_customize name=ppa_cat_customize type=checkbox '. ( get_option('ppa_cat_customize') == 'on' ? 'checked' : '' ) . ' /><label for=ppa_cat_customize>Show the Customize Button in Product Category</label>';
	}
